...
require("models/model.Veranstalter.php");
require("models/model.Laufevent.php");
require("models/model.Lauf.php");
require("models/model.Laeufer.php");
require("models/model.GruppeT.php");
require("models/model.KategorieT.php");
require("models/model.BestaetigungT.php");
require("models/model.GeschlechtT.php");
require("models/model.AltersklasseT.php");
